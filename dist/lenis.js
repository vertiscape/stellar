(function (global, factory) {
  ...
  */
  ...
  function cubicBezier(input) {
      // If this is a linear gradient, return linear easing
      if (input[0] === input[1] && input[2] === input[3])
          return noop;
      const getTForX = (aX) => binarySubdivide(aX, 0, 1, input[0], input[2]);
      // If animation is at start/end, return t without easing
      return (t) => t === 0 || t === 1 ? t : calcBezier(getTForX(t), input[1], input[3]);
  }
  const noop = (any) => any;
  ...
  class Lenis {
      ...
      userData, } = {}) {
          ...
          if (target === this.targetScroll) {
              ...
              onComplete === null || onComplete === void 0 ? void 0 : onComplete(this, false);
              return;
          }
          ...
          if (immediate) {
              ...
              this.emit();
              onComplete === null || onComplete === void 0 ? void 0 : onComplete(this, true);
              this.userData = {};
              return;
          }
          if (!programmatic) {
